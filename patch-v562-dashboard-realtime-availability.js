...
(function(){
  ...
  function versionChip(){try{document.querySelectorAll('.v520-version-chip,.v542-version-chip').forEach(chip=>{chip.textContent='v565';chip.title='Realtime manpower availability by leave + activity time (V562)';});}catch(_){ }}
