/* CNMI Staff Planner V314 — early interaction router
...
(function(){
  'use strict';
  const VERSION='V314_INTERACTION_PRELOAD';
  if(window.__CNMI_V314_INTERACTION_PRELOAD__) return;
  window.__CNMI_V314_INTERACTION_PRELOAD__=true;
  ...
  window.__cnmiV314Preload={openCalendar,showModalDom,toast,stateSafe};
