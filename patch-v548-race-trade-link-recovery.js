...
(function(){
  ...
  if(window.__CNMI_V548_RACE_TRADE_LINK_RECOVERY__) return;
  window.__CNMI_V548_RACE_TRADE_LINK_RECOVERY__=true;
  ...
  window.cnmiV548Race={version:VERSION,buildPlans,daytimePlan,dutyPlan,positionRole,selectedDate,reportRosterHtml,effectiveDutyRows,tradeBoundaries,rawDutyRows,effectiveDutySegments,completedTradeRowsForDate,tradeMatchesAssignment};
  window.cnmiV505Race=window.cnmiV548Race;
